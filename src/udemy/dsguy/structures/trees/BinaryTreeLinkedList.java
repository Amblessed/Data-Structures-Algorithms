...
public class BinaryTreeLinkedList<T> {
	...
	void insert(T value)
	{
		...
		while (!queue.isEmpty())
		{
			...
			System.out.println("----> "+ presentNode.toString());
			if (presentNode.getLeft() == null)
			{
				presentNode.setLeft(node);
				System.out.println("Successfully inserted new node at the left! " + node.getValue());
				break;
			}
			else if (presentNode.getRight() == null)
			{
				presentNode.setRight(node);
				System.out.println("Successfully inserted new node at the right! " + node.getValue());
				break;
			}
			else
			{
	...
	void deleteNodeOfBinaryTree(T value) {
		Queue<BinaryNode> queue = new LinkedList<>();
		queue.add(root);
		while (!queue.isEmpty())
		{
